...
public class AffichageConsole {
	...
	public void inscription() {
		System.out.println("*** Quel r�le voulez vous ? ***");
		...
		System.out.println("*** Vous �tes maintenant connect� en temps que " + this.testRole + ".");
	}
	...
	public void deconnexion() {
		if (!this.testRole.equals("invite")) {
			...
			System.out.println("Vous �tes d�j� d�connect� !");
		}
		System.out.println("*** Vous �tes maintenant connect� en temps que " + this.testRole + ".");
	}
	...
	public void choixMenuLibraire(int pChoixML) {
		...
		case 1: // Client
			...
			System.out.println("(1) Valider cr�ation compte");
			System.out.println("(2) Refuser cr�ation compte");
			System.out.println("(3) D�sactiver compte");
